...
Original file is located at
    https://colab.research.google.com/drive/1qPvD1Ef-D5q7bF6E1I01XvQAK_l4HkMH
...
print(">>> Fitur .index()")
list_score = ['Budi','Sud','Budi','Budi','Budi','Sud','Sud']
score_pertama_sud = list_score.index('Sud') + 1  # Menambahkan 1 karena indeks dimulai dari 0
print(score_pertama_sud)  # Output: 2

# Fitur .insert()
print(">>> Fitur .insert()")
list_score = ['Budi','Sud','Budi','Budi','Sud']
list_score.insert(3, 'Sud')  # Menyisipkan 'Sud' pada indeks ke-3
print(list_score)  # Output: ['Budi', 'Sud', 'Budi', 'Sud', 'Budi', 'Sud']

# Fitur .pop()
print(">>> Fitur .pop()")
list_menu = ['Gado-gado', 'Ayam Goreng', 'Rendang']
list_menu.pop(1)  # Menghapus elemen pada indeks 1 (Ayam Goreng)
print(list_menu)  # Output: ['Gado-gado', 'Rendang']

# Fitur .remove()
print(">>> Fitur .remove()")
list_menu = ['Gado-gado', 'Ayam Goreng', 'Rendang', 'Ketoprak']
list_menu.remove('Rendang')  # Menghapus elemen 'Rendang'
print(list_menu)  # Output: ['Gado-gado', 'Ayam Goreng', 'Ketoprak']

# Fitur .reverse()
print(">>> Fitur .reverse()")
list_menu = ['Gado-gado', 'Ayam Goreng', 'Rendang', 'Ketoprak']
list_menu.reverse()  # Membalik urutan list
print(list_menu)  # Output: ['Ketoprak', 'Rendang', 'Ayam Goreng', 'Gado-gado']

# Fitur .sort()
print(">>> Fitur .sort()")
list_menu = ['Gado-gado', 'Ayam Goreng', 'Rendang', 'Ketoprak']
list_menu.sort()  # Default: Ascending
print(list_menu)  # Output: ['Ayam Goreng', 'Gado-gado', 'Ketoprak', 'Rendang']
list_menu.sort(reverse=True)  # Descending
print(list_menu)  # Output: ['Rendang', 'Ketoprak', 'Gado-gado', 'Ayam Goreng']
...
print(parcel1)  # {'Anggur', 'Apel', 'Jeruk'}
print(parcel3)  # {'Anggur', 'Apel', 'Jeruk', 'Kiwi', 'Melon'}
...
print(parcel1_parcel2_disjoint)  # True
parcel1_parcel3_disjoint = parcel1.isdisjoint(parcel3)
print(parcel1_parcel3_disjoint)  # False
...
print(parcel_C)  # {'Apel', 'Jeruk'}

# Fitur .difference()
print(">>> Fitur .difference()")
parcel_C = parcel_A.difference(parcel_B)
print(parcel_C)  # {'Anggur', 'Kiwi', 'Melon'}
...
print(parcel_C)  # {'Anggur', 'Melon', 'Semangka', 'Leci'}
...
Aku pun melanjutkan prosesnya dengan membaca file harga_rumah.txt dan merepresentasikan setiap data ke dalam tipe data dictionary dan menampung keseluruhan data dalam sebuah list bernama harga_rumah. Setelah selesai memasukkan data dan menemukan jika nilai dari setiap atribut (tanah, bangunan, jarak_ke_pusat) tidak setara, aku mulai agak bingung. Tapi, harus tenang dan jangan panik!
...
Hitunglah prediksi harga dari variabel data tersebu
"""
